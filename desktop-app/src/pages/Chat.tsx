...
export function Chat() {
    ...
    const messages = useConvexQuery(api.messages.list, selectedChatId ? { chatId: selectedChatId } : "skip") || [];
    ...
    const handleCreateChat = async () => {
        const newChatId = await createChat({ title: "New Chat", model: "google/gemini-1.5-flash" });
                ...
                <div className="flex-1 overflow-y-auto px-2 space-y-1">
                    {chats.map((chat: any) => (
                        <div
                            ...
                            className={`group flex items-center justify-between p-3 rounded-lg cursor-pointer transition ${selectedChatId === chat._id ? "bg-gray-700 text-white" : "text-gray-400 hover:bg-gray-700/50 hover:text-gray-200"
                                }`}
                        >
