                ...
                <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-900 border border-gray-700 p-6 rounded-xl w-[400px] z-50 shadow-2xl">
                    <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-3">
                            <div className={`p-2 rounded-full ${isDangerous ? "bg-red-900/30 text-red-400" : "bg-blue-900/30 text-blue-400"}`}>
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition ${isDangerous
