...
function LogoPlane() {
  ...
  const texture = useTexture(
    "https://harmless-tapir-303.convex.cloud/api/storage/87893b86-54f0-457c-9239-2ebfde8a2814",
  );
  ...
  useFrame((state) => {
    ...
    meshRef.current.rotation.y =
      Math.sin(clock.getElapsedTime() * 0.3) * 0.1 + mouse.x * 0.2;
    meshRef.current.rotation.x =
      Math.cos(clock.getElapsedTime() * 0.2) * 0.1 - mouse.y * 0.2;
  });
