...
const textModels = [
  ...
  // Groq Models (Requires API Key - Fast Inference)
  { id: "groq/llama-3.1-70b-versatile", name: "Llama 3.1 70B Versatile", provider: "Groq", description: "Fast, versatile 70B model" },
  { id: "groq/llama-3.1-8b-instruct", name: "Llama 3.1 8B Instruct", provider: "Groq", description: "Fast 8B instruction model" },
  { id: "groq/llama-3.3-70b-versatile", name: "Llama 3.3 70B Versatile", provider: "Groq", description: "Latest Llama 3.3 model" },
  { id: "groq/mixtral-8x7b-32768", name: "Mixtral 8x7B", provider: "Groq", description: "Fast MoE model with 32K context" },
  { id: "groq/mixtral-8x22b-instruct-v0.1", name: "Mixtral 8x22B Instruct", provider: "Groq", description: "Large fast MoE model" },
  { id: "groq/gemma-7b-it", name: "Gemma 7B IT", provider: "Groq", description: "Fast Google Gemma model" },
  { id: "groq/gemma2-9b-it", name: "Gemma 2 9B IT", provider: "Groq", description: "Fast Gemma 2 model" },
  { id: "groq/gemma2-27b-it", name: "Gemma 2 27B IT", provider: "Groq", description: "Large fast Gemma 2" },
  { id: "groq/deepseek-r1-distill-llama-70b", name: "DeepSeek R1 Distill Llama 70B", provider: "Groq", description: "Fast reasoning model" },
  { id: "groq/qwen2.5-72b-instruct", name: "Qwen 2.5 72B Instruct", provider: "Groq", description: "Fast large Qwen model" },
  { id: "groq/qwen2.5-32b-instruct", name: "Qwen 2.5 32B Instruct", provider: "Groq", description: "Fast mid-size Qwen" },
  { id: "groq/qwen2.5-14b-instruct", name: "Qwen 2.5 14B Instruct", provider: "Groq", description: "Fast compact Qwen" },
  { id: "groq/qwen2.5-7b-instruct", name: "Qwen 2.5 7B Instruct", provider: "Groq", description: "Fast small Qwen" },
  { id: "groq/llama-3.2-90b-vision-instruct", name: "Llama 3.2 90B Vision", provider: "Groq", description: "Fast vision model" },
  { id: "groq/llama-3.2-11b-vision-instruct", name: "Llama 3.2 11B Vision", provider: "Groq", description: "Fast compact vision" },
  { id: "groq/pixtral-12b", name: "Pixtral 12B", provider: "Groq", description: "Fast vision-language model" },
  ...
  { id: "agentrouter/claude-3-haiku", name: "Claude 3 Haiku", provider: "AgentRouter", description: "Free Claude 3 Haiku" },
  { id: "agentrouter/gpt-4-turbo", name: "GPT-4 Turbo", provider: "AgentRouter", description: "Free GPT-4 Turbo" },
  { id: "agentrouter/gpt-4o", name: "GPT-4o", provider: "AgentRouter", description: "Free GPT-4o" },
  { id: "agentrouter/gpt-3.5-turbo", name: "GPT-3.5 Turbo", provider: "AgentRouter", description: "Free GPT-3.5 Turbo" },
  { id: "agentrouter/gemini-pro-1.5", name: "Gemini Pro 1.5", provider: "AgentRouter", description: "Free Gemini Pro" },
  { id: "agentrouter/gemini-flash-1.5", name: "Gemini Flash 1.5", provider: "AgentRouter", description: "Free Gemini Flash" },
  { id: "agentrouter/llama-3.1-70b", name: "Llama 3.1 70B", provider: "AgentRouter", description: "Free Llama 3.1 70B" },
  { id: "agentrouter/llama-3.1-8b", name: "Llama 3.1 8B", provider: "AgentRouter", description: "Free Llama 3.1 8B" },
  { id: "agentrouter/mixtral-8x7b", name: "Mixtral 8x7B", provider: "AgentRouter", description: "Free Mixtral 8x7B" },
  { id: "agentrouter/qwen2.5-72b", name: "Qwen 2.5 72B", provider: "AgentRouter", description: "Free Qwen 2.5 72B" },
  { id: "agentrouter/qwen2.5-14b", name: "Qwen 2.5 14B", provider: "AgentRouter", description: "Free Qwen 2.5 14B" },
  { id: "agentrouter/deepseek-r1", name: "DeepSeek R1", provider: "AgentRouter", description: "Free DeepSeek R1" },
