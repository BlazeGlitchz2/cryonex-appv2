                                    ...
                                    <button className={cn(
                                        ...
                                        {!isCollapsed && (
                                            <div className="flex-1 min-w-0">
                                                <p className={cn("text-sm font-bold truncate", isCosmic ? "text-white" : "text-foreground")}>{user.name || user.email?.split("@")[0] || "User"}</p>
                        ...
                        {!isCollapsed ? (
                            <div className="relative group">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        "w-full h-11 pl-10 pr-4 flex items-center text-left bg-card/30 border border-border/20 hover:bg-card/50 rounded-full transition-all text-sm text-muted-foreground",
                                        isCosmic ? "text-white/70 hover:text-white" : "text-muted-foreground hover:text-foreground"
                                    )}
                                >
                            ...
                            <div className="flex justify-center">
                                <Button variant="ghost" size="icon" onClick={() => setGlobalSearchOpen(true)} className="h-10 w-10 rounded-xl bg-card/30 hover:bg-card/50">
