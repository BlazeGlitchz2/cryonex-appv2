...
const MobileAttachmentPreview = ({
    ...
    if (!url) {
        return (
            <div className="h-16 w-16 bg-white/5 animate-pulse rounded-xl" />
        );
    }
            ...
            <div className="flex gap-2 px-3 py-1">
                ...
                >
                    ...
                    {searchContent && (
                        <SearchStatus
                            query={searchContent}
                            isFinished={!isStreaming || !!content || !!thinkingContent}
                            className="mb-3"
                        />
                    )}
                    ...
                    <div className={cn(
                        ...
                        {isStreaming && !content && (
                            <div className="flex items-center gap-1 py-2">
                                ...
                                <div className="h-2 w-2 rounded-full bg-cyan-400 animate-pulse delay-100" />
                                <div className="h-2 w-2 rounded-full bg-cyan-400 animate-pulse delay-200" />
                            </div>
                        )}
                    </div>
