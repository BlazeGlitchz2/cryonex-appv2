    ...
    const cards: Card[] = [
        {
            ...
            description: "Analyze complex documents in seconds. Our AI breaks down dense academic papers into digestible insights.",
        ...
        },
        {
            ...
            description: "Turn your study notes into shareable content. Automatically generate quizzes, flashcards, and summaries to share with peers.",
        ...
        },
        {
            ...
            description: "Connect ideas across thousands of sources. Visualize relationships between concepts to deepen your understanding.",
        ...
        },
        {
            ...
            description: "Study together with AI-powered tools. Collaborate on documents and research in real-time with students worldwide.",
