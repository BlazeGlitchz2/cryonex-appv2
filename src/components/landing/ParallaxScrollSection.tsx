...
export function ParallaxScrollSection() {
    ...
    return (
        <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
            ...
            {/* Content */}
            <div ref={textRef} className="relative z-10 max-w-7xl mx-auto px-6 text-center">
                ...
                <p className="text-xl md:text-2xl text-white/60 max-w-3xl mx-auto leading-relaxed">
                    Experience a new dimension of knowledge. Immerse yourself in interactive 3D environments where ideas come to life.
                </p>
            </div>
        </section>
    );
