          ...
          <div className="flex-1 relative z-10">
            <ScrollReveal variant={reversed ? "fade-left" : "fade-right"}>
              <div className="relative">
                ...
                <div
                  className={cn(
                    "absolute -inset-4 bg-gradient-to-r blur-3xl opacity-20 rounded-full",
                    gradient,
                  )}
                />
          ...
          <div className="flex-1 w-full">
            <ScrollReveal variant="scale-up">
              <div className="relative group aspect-video md:aspect-square rounded-3xl overflow-hidden border border-white/10 bg-black/50">
                <div
                  className={cn(
                    "absolute inset-0 bg-gradient-to-tr opacity-20 group-hover:opacity-30 transition-opacity duration-700",
                    gradient,
                  )}
                />
                <img
