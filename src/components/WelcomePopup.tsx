...
export function WelcomePopup() {
    ...
    useEffect(() => {
        const hiddenForever = localStorage.getItem("cryonex_welcome_hidden_forever");
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-4 border-b border-white/5 cursor-grab active:cursor-grabbing">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-mono text-white/50 uppercase tracking-wider">System Notification</span>
                            </div>
                            <button
                                onClick={handleClose}
                        ...
                        <div className="p-6 space-y-6">
                            <div className="flex flex-col items-center text-center space-y-4">
                                ...
                                <div className="space-y-1">
                                    <h2 className="text-2xl font-bold tracking-tight">Welcome to Cryonex</h2>
                                    <p className="text-primary font-mono text-xs font-bold uppercase tracking-widest">Test Release v0.9.0</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 rounded-xl p-3 border border-white/10 text-center">
                                <p className="text-[10px] text-white/40 uppercase tracking-wider mb-1">Report Issues & Feedback</p>
                                <a
