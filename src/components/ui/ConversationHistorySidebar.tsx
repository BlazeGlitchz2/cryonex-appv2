...
export function ConversationHistorySidebar({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent
        side="left"
        className="w-[280px] sm:w-[280px] bg-background/80 backdrop-blur-md border-r dark:border-r-border/50"
      >
        <div className="flex flex-col h-full">
          <div className="p-4 border-b dark:border-b-border/50">
            ...
            <Button
              ...
              className="sidebar-nav-item relative w-full mb-2"
              variant="outline"
            >
              ...
              filteredChats.map((chat: ChatItem) => {
                ...
                return (
                  ...
                  >
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-6 w-6 p-0 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-background/50"
                          >
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="w-48 bg-popover/95 backdrop-blur-lg border-border"
                        >
                          <DropdownMenuItem
                            onClick={() => {
                              /* Inline rename logic */
                    ...
                    {chat.isPinned && (
                      <div className="absolute top-2 right-2 w-2 h-2 bg-primary rounded-full z-10 shadow-[0_0_8px_rgba(var(--primary),0.5)]" />
                    )}
                  </div>
                );
              })
