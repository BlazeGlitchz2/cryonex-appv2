...
export default function AIThinkingBlock({ thinking, isFinished = false, className }: AIThinkingBlockProps) {
    ...
    return (
        <div className={cn("my-4 rounded-xl overflow-hidden border border-white/10 bg-black/20", className)}>
            {/* Header / Summary */}
            <button
                onClick={toggle}
            ...
            >
                <div className="flex items-center gap-2.5">
                    <div className={cn("p-1.5 rounded-lg transition-colors", isFinished ? "bg-emerald-500/10 text-emerald-400" : "bg-cyan-500/10 text-cyan-400")}>
                        {isFinished ? (
