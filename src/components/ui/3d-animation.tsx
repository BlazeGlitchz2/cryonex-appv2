        ...
        <div className="relative w-full h-[600px] flex items-center justify-center perspective-1000 pointer-events-none">
            ...
            >
                <div className="relative w-[200px] h-[200px] preserve-3d animate-3d-rotate">
                    ...
                    {/* Text Faces */}
                    <div className="absolute w-[200px] h-[200px] bg-white/5 border border-white/20 backdrop-blur-sm transform translate-x-[-100px] rotate-y-[-90] flex items-center justify-center p-6 text-xs text-white/90 font-mono leading-relaxed overflow-hidden shadow-[inset_0_0_20px_rgba(139,92,246,0.2)]" dangerouslySetInnerHTML={{ __html: poemHTML }}></div>
                    <div className="absolute w-[200px] h-[200px] bg-white/5 border border-white/20 backdrop-blur-sm transform translate-x-[100px] rotate-y-90 flex items-center justify-center p-6 text-xs text-white/90 font-mono leading-relaxed overflow-hidden shadow-[inset_0_0_20px_rgba(139,92,246,0.2)]" dangerouslySetInnerHTML={{ __html: poemHTML }}></div>
                    ...
                    <div className="absolute w-[200px] h-[200px] bg-white/5 border border-white/20 backdrop-blur-sm transform translate-z-[-100px] rotate-y-180 flex items-center justify-center p-6 text-xs text-white/90 font-mono leading-relaxed overflow-hidden shadow-[inset_0_0_20px_rgba(139,92,246,0.2)]" dangerouslySetInnerHTML={{ __html: poemHTML }}></div>
