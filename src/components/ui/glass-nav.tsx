...
export function GlassNav({ title, actions, onMenuToggle }: GlassNavProps) {
  ...
  return (
    <div
      className={
        isMobile ? "sticky top-0 z-50 px-3 pt-2" : "sticky top-0 z-50 px-4 pt-3"
      }
    >
      <div
      ...
      >
        ...
        <div className="md:hidden">
          ...
          >
            ...
            <SheetContent
              side="left"
              className="w-[85vw] sm:w-80 bg-[#121212] text-white border-white/10 bg-white/10 backdrop-blur-md backdrop-saturate-150 border border-white/20 shadow-[0_8px_40px_rgba(0,0,0,0.35)]"
            >
              <div
