...
export function RatingInteraction({ onChange, className }: RatingInteractionProps) {
    ...
    return (
        <div className={cn("flex flex-col items-center gap-6 p-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_0_20px_rgba(0,0,0,0.5)]", className)}>
                        ...
                        >
                            <div
                                className={cn(
                                    ...
                                    isActive ? "scale-110 bg-white/10" : "scale-100 group-hover:scale-105",
                                )}
                            >
                                <span
                                    className={cn(
            ...
            <div className="relative h-7 w-32">
                ...
                >
                    <span className="text-sm font-medium text-neutral-400">Rate us</span>
                </div>
                ...
                {ratingData.map((item, i) => (
                    ...
                    >
                        <span className="text-sm font-semibold tracking-wide text-white text-glow">{item.label}</span>
                    </div>
                ))}
            </div>
        </div>
