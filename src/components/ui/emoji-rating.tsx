...
export function RatingInteraction({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center gap-6 p-6 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_0_20px_rgba(0,0,0,0.5)]",
        className,
      )}
    >
      ...
      <div className="relative h-7 w-32">
        ...
        {ratingData.map((item, i) => (
          ...
          >
            <span className="text-sm font-semibold tracking-wide text-white text-glow">
              {item.label}
            </span>
          </div>
        ))}
