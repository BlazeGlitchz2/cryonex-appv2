...
export const IconCryonex = ({ className }: { className?: string }) => (
    <img
...
export const IconAssistant = ({ className }: { className?: string }) => (
...
export const IconLibrary = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M4 19.5C4 18.8 4.2 18.1 4.5 17.5L12 3L19.5 17.5C19.8 18.1 20 18.8 20 19.5C20 20.9 18.9 22 17.5 22H6.5C5.1 22 4 20.9 4 19.5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        <circle cx="12" cy="12" r="6" stroke="currentColor" strokeWidth="1.5" strokeDasharray="2 2" className="opacity-50" />
    </svg>
);

export const IconProjects = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
...
export const IconStudio = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" />
        <path d="M12 8L14.5 12L12 16L9.5 12L12 8Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
export const IconStudy = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M4 19.5V6.5C4 5.1 5.1 4 6.5 4H17.5C18.9 4 20 5.1 20 6.5V19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M4 19.5C4 20.9 5.1 22 6.5 22H17.5C18.9 22 20 20.9 20 19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 4V22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
export const IconBrain = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" strokeWidth="1.5" className="opacity-20" />
        <path d="M12 16V12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M12 8H12.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M9 12C9 12 9.5 10 12 10C14.5 10 15 12 15 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M8 15C8 15 9 17 12 17C15 17 16 15 16 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
...
export const IconTarget = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5" className="opacity-50" />
        <circle cx="12" cy="12" r="6" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="12" cy="12" r="2" className="fill-current" />
        <path d="M12 2V4" stroke="currentColor" strokeWidth="1.5" />
        <path d="M12 20V22" stroke="currentColor" strokeWidth="1.5" />
        <path d="M2 12H4" stroke="currentColor" strokeWidth="1.5" />
        <path d="M20 12H22" stroke="currentColor" strokeWidth="1.5" />
    </svg>
);
...
export const IconTime = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M4 4L20 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" className="opacity-20" />
    </svg>
);

export const IconData = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
...
export const IconImage = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <rect x="3" y="3" width="18" height="18" rx="5" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="9" cy="9" r="2" className="fill-current" />
...
export const IconVideo = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        ...
        <path d="M10 9L15 12L10 15V9Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="fill-current" />
        <path d="M2 8H22" stroke="currentColor" strokeWidth="1.5" className="opacity-30" />
        <path d="M2 16H22" stroke="currentColor" strokeWidth="1.5" className="opacity-30" />
    </svg>
);

export const IconAudio = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <rect x="4" y="4" width="16" height="16" rx="8" stroke="currentColor" strokeWidth="1.5" />
        <path d="M8 12H9" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M11 10V14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        <path d="M13 9V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
...
export const IconWand = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M4.5 12.5L11.5 5.5C12.0523 4.94772 12.9477 4.94772 13.5 5.5L18.5 10.5C19.0523 11.0523 19.0523 11.9477 18.5 12.5L11.5 19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M2 22L4.5 19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M16 5L19 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M19 5L16 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const IconFolder = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M2 11V19C2 20.6569 3.34315 22 5 22H19C20.6569 22 22 20.6569 22 19V9C22 7.34315 20.6569 6 19 6H12L10 4H5C3.34315 4 2 5.34315 2 7V11Z" stroke="currentColor" strokeWidth="1.5" />
        <path d="M2 11H22" stroke="currentColor" strokeWidth="1.5" className="opacity-30" />
    </svg>
);
...
export const IconList = ({ className }: { className?: string }) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M8 6H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M8 12H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <path d="M8 18H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
