...
export function OptimizedImage({
    ...
    const placeholderSrc = 'data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"%3E%3Crect fill="%23111" width="1" height="1"/%3E%3C/svg%3E';
    ...
    return (
        ...
        >
            ...
            <img
                ...
                sizes={srcSet ? '(max-width: 640px) 100vw, (max-width: 1024px) 80vw, 1200px' : undefined}
                alt={alt}
                width={width}
                height={height}
...
export function OptimizedBackground({
    ...
    const quality = imageQuality === 'low' ? 40 : imageQuality === 'medium' ? 60 : 80;
    const format = getPreferredImageFormat();
