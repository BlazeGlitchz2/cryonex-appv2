              ...
              {props.testimonials.map(({ text, image, name, role }, i) => (
                <motion.li
                  ...
                  whileHover={{
                    ...
                    y: -8,
                    boxShadow:
                      "0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 10px 10px -5px rgba(0, 0, 0, 0.04), 0 0 0 1px rgba(255, 255, 255, 0.1)",
      ...
      >
        <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-16">
          ...
          <h2
            ...
            className="text-4xl md:text-5xl font-extrabold tracking-tight mt-6 text-center text-white transition-colors text-glow"
          >
            Student Success Stories
          </h2>
          <p className="text-center mt-5 text-white/50 text-lg leading-relaxed max-w-sm transition-colors">
            See how Cryonex is transforming the academic journey for students at
            JIS and beyond.
          </p>
        </div>
