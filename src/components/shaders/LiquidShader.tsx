...
export default function LiquidShader() {
  // Optimization: Don't render heavy shader on Android/Mobile
  if (typeof navigator !== 'undefined' && (/Android|iPhone|iPad|iPod/i.test(navigator.userAgent) || window.innerWidth < 768)) {
    return (
