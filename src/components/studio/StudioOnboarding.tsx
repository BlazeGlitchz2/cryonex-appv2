...
export function StudioOnboarding({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[98vw] w-[95vw] h-[600px] p-0 gap-0 bg-[#1e1e1e] text-[#cccccc] border-[#333] shadow-2xl sm:rounded-xl overflow-hidden flex flex-col outline-none">
        ...
        <div className="h-10 bg-[#252526] flex items-center justify-between px-4 border-b border-[#333] shrink-0 select-none">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-[#cccccc] ml-2">
              Welcome to Cryonex Studio
            </span>
          </div>
          <Button
            variant="ghost"
            size="icon"
            className="h-6 w-6 text-[#cccccc] hover:bg-[#333]"
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="w-[300px] bg-[#252526] border-r border-[#1e1e1e] flex flex-col shrink-0">
            <div className="p-8">
              <h2 className="text-xs font-bold text-[#6f6f6f] uppercase tracking-wider mb-6">
                Get Started
              </h2>
                    ...
                    >
                      ...
                      <div className="col-span-2 flex justify-center">
                        <ThemeOption
                          ...
                          preview={
                            <div className="w-full h-40 bg-[#0a0a0a] rounded-md border border-[#333] relative overflow-hidden shadow-xl">
                  ...
                  {step === 2 && (
                    ...
                    >
                      <div className="space-y-3">
                        ...
                        <p className="text-[#888] text-xl">
                          Select your primary language to configure the
                          environment.
                        </p>
                      </div>
            ...
            <div className="p-8 border-t border-[#333] flex justify-between items-center bg-[#1e1e1e] shrink-0">
              {step > 1 ? (
                <Button
                  ...
                  className="text-[#cccccc] hover:text-white hover:bg-[#333] h-12 px-6 text-base"
                >
                  Back
                </Button>
              ) : (
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {active && (
          <div className="w-5 h-5 rounded-full bg-[#007acc] flex items-center justify-center">
