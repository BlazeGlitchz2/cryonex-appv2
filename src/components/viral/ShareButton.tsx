...
export function ShareButton({ id, type, title, isPublic, existingShareId }: ShareButtonProps) {
    ...
    const shareUrl = shareId ? `${window.location.origin}/share/${type}/${shareId}` : "";
                    ...
                    {!shareId ? (
                        <div className="flex flex-col items-center justify-center py-8 space-y-4 text-center">
                            ...
                            <p className="text-sm text-white/50 max-w-[200px]">
                                This content is currently private. Publish it to share with others.
                            </p>
                            <Button
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-white/50 uppercase tracking-wider">Public Link</label>
