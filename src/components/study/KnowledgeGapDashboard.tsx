            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Progress
                  ...
                  className={`h-2 ${
                    gap.status === "strong"
                      ? "bg-green-900/20 [&>div]:bg-green-500"
                      : gap.status === "average"
                        ? "bg-yellow-900/20 [&>div]:bg-yellow-500"
          ...
          <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-400">
                ...
                .
                {materialId
                  ? " Generate a targeted guide to close these gaps."
                  : " Go to the relevant study material to generate a review guide."}
              </p>
            </div>
            {materialId && (
              <Button
