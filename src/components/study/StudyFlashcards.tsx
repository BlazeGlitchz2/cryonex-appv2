...
export function StudyFlashcards({
  ...
  const handleGenerate = async () => {
    if (!materialId) {
      ...
      toast.error(
        "Study material not found. Please re-upload or select a valid material.",
      );
      return;
    }
    ...
    if (content.length < 50) {
      toast.error(
        "Source material is too short for high-quality AI generation. Please add more content first.",
        {
            ...
            <div className="flex shrink-0 gap-2">
              ...
              >
                <DialogTrigger asChild>
                  <Button
                    size="sm"
                    className="rounded-full bg-blue-500 px-3 text-white hover:bg-blue-600"
                  >
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden bg-[#f8fafc] text-slate-950 dark:bg-[#080b10] dark:text-white">
      <div className="custom-scrollbar min-h-0 flex-1 overflow-y-auto overscroll-contain">
        <div className="mx-auto flex w-full max-w-[110rem] flex-col gap-5 px-3 py-4 pb-24 sm:px-4 md:px-6 lg:px-8">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-600 dark:text-slate-400">
                  Generate, review, and grade source-grounded cards tied to this
                  workspace. Progress updates as you score each card.
                </p>
              </div>
                      ...
                      <CardContent className="p-0">
                        <AnimatePresence mode="wait">
                          <motion.div
                            ...
                            className="flex min-h-[30rem] max-h-[min(68vh,780px)] flex-col"
                          >
                  ...
                  <CardContent className="space-y-5 p-5">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm leading-6 text-slate-600 dark:text-slate-400">
                        Reveal the answer, score yourself, and move on. The
                        rating buttons update spaced repetition and advance the
                        deck.
                      </p>
                    </div>
                    ...
                    <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
                      ...
                      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
                        ...
                        <p className="mt-2 text-sm font-medium text-slate-900 dark:text-white">
                          {masteredCount} mastered, {learningCount} still in
                          learning.
                        </p>
                      </div>
                      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
