  ...
  return (
    <div className="h-screen w-full bg-[#030014] text-white overflow-hidden flex flex-col font-sans selection:bg-cyan-500/30">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-cyan-900/20 rounded-full blur-[120px] animate-pulse delay-1000" />
      ...
      <div className="flex-1 flex overflow-hidden relative z-10 p-4 gap-4">
        ...
        <motion.aside
          ...
          className="hidden lg:flex flex-col w-20 shrink-0 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl py-6 gap-4 items-center shadow-2xl"
        >
          {sidebar}
        </motion.aside>
        ...
        <motion.main
          ...
          className="flex-1 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl relative flex flex-col"
        >
          {/* Content Glow */}
        ...
        <motion.aside
          ...
          className="hidden lg:flex w-[400px] shrink-0 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex-col"
        >
          {chat}
        </motion.aside>
      </div>
