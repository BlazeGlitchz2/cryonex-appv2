      ...
      >
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-xl text-sm leading-6 text-white/52">
      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-[minmax(0,1fr)_auto]">
          <div className="relative group/search min-w-0">
            <SearchIcon className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-white/30 transition-colors group-hover/search:text-white/60" />
            <input
              type="text"
              placeholder="Search study material"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="deepshi-panel w-full rounded-2xl border border-white/[0.06] bg-white/[0.04] py-3 pl-10 pr-4 text-sm text-white placeholder:text-white/25 focus:outline-none focus:ring-1 focus:ring-white/10"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:items-center">
            <Button
              ...
              className="deepshi-panel h-11 rounded-2xl px-4 text-white hover:bg-white/10"
            >
              <Sparkles className="mr-2 h-4 w-4 text-white/40" />
              Copilot
            </Button>
            ...
            <Button
              ...
              className="deepshi-panel h-11 rounded-2xl bg-white px-4 font-semibold text-black hover:bg-white/90"
            >
