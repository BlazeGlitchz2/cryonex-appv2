      ...
      <div className="fixed inset-0 z-[9998] bg-[#030010] flex flex-col safe-top safe-bottom">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-white/5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/30 text-[10px]">Cached · Read-only</p>
          </div>
        </div>
    ...
    <div className="fixed inset-0 z-[9998] bg-[#030010] flex flex-col items-center safe-top safe-bottom animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 w-full max-w-md">
        ...
        <button
          ...
          className={cn(
            "w-full mb-6 flex items-center gap-3 px-4 py-3 rounded-2xl transition-all",
            localAIAvailability.isAvailable
              ? "bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-500/30 active:scale-95"
              : "bg-white/[0.03] border border-white/10 text-white/45 cursor-not-allowed",
          )}
        >
          <div
            className={cn(
              "h-10 w-10 rounded-xl flex items-center justify-center",
              localAIAvailability.isAvailable ? "bg-blue-500/20" : "bg-white/5",
            )}
          >
          ...
          <div className="text-left">
            ...
            <p className="text-white/40 text-xs">
              {localAIAvailability.isAvailable
                ? "Use the on-device model path"
                : localAIAvailability.reason}
            </p>
          </div>
        </button>
      ...
      <div className="relative z-10 w-full px-4 pb-6">
        {cachedChats.length > 0 ? (
          ...
          <div className="text-center py-6 rounded-2xl bg-white/[0.02] border border-white/5">
            ...
            <p className="text-white/25 text-xs">No cached chats available</p>
