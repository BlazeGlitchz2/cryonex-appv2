      ...
      <div className="flex-1 flex items-center justify-center h-full">
        <div className="text-center space-y-4">
          ...
          <p className="text-white/60 max-w-md mx-auto">
            Sign in to join our affiliate program and earn rewards for referring
            new users to Cryonex.
          </p>
          <Button
    ...
    return (
      <div className="flex-1 flex items-center justify-center h-full">
        <div className="text-center space-y-4">
          ...
          <Button
            onClick={() => {
              createAffiliate({}).catch((err) => {
                console.error(err);
                toast.error(
                  "Failed to create affiliate link. Please try again.",
                );
              });
            }}
