      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          <section>
            ...
            <p>
              Welcome to Cryonex. We respect your privacy and are committed to
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">
              6. EU User Consent Policy
            </h2>
            <p className="mb-4">
              If you are located in the European Economic Area (EEA), the United
              Kingdom, or Switzerland, we comply with the EU User Consent
              Policy. This means:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li>
                We obtain your consent before storing or accessing cookies and
                other information on your device.
              </li>
              <li>
                We obtain your consent before collecting, sharing, and using
                personal data for personalization of ads.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mb-4">
              You can manage your cookie preferences at any time. To change your
              cookie settings:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>
                Visit the Google Ad Settings page to control personalized
                advertising
              </li>
            </ul>
            <p className="mt-4">
              Please note that blocking certain cookies may impact your
              experience on our website and limit the functionality of some
              features.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li>
                <strong>Advertising Partners:</strong> We work with Google
                AdSense and other advertising partners who may collect
                information about your browsing activities to provide relevant
                advertisements.
              </li>
              <li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">
              9. Device Tracking & Security Monitoring
            </h2>
            <p className="mb-4">
              To ensure the security of your account and our platform, we
              collect and monitor device and session information when you use
              Cryonex. This helps us detect unauthorized access and protect all
              users.
            </p>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li>
                <strong>Device Information:</strong> Browser type/version,
                operating system, device type (mobile/desktop/tablet)
              </li>
              <li>
              ...
              <li>
                <strong>Session Data:</strong> Login timestamps, session
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>
                Alerting you to suspicious login activity from new devices or
                locations
              </li>
              <li>Enabling you to view and manage your active sessions</li>
              <li>
                Complying with legal requirements and protecting against abuse
              </li>
            </ul>
            <h3 className="text-xl font-semibold text-white mb-3 mt-4">
              Your Rights
            ...
            <p className="mb-4">
              You have the right to view your active sessions and terminate any
              session at any time through your account settings. Administrators
              may also review session data for security purposes. Session data
              is retained for 90 days after the session ends, after which it is
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 mt-4">
              ...
              <p className="text-white/70">
                By using Cryonex, you consent to the collection and processing
                of device and location information as described above. This
                monitoring is essential for maintaining the security of our
                platform and protecting user accounts. If you do not consent to
                this monitoring, please discontinue use of our services.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              practices, please contact us at support@cryonex.ai.
            </p>
          </section>
        </div>
      </div>
