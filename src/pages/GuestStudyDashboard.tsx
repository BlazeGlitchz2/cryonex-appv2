      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <section className="couture-panel overflow-hidden rounded-[32px] border border-white/10 p-5 backdrop-blur-xl sm:p-8">
          <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="grid gap-4 sm:min-w-[310px]">
              <div className="cyber-tactile-card hidden min-h-[150px] items-center justify-center rounded-[28px] p-5 sm:flex">
                <div className="cyber-orb h-24 w-24" />
              </div>
