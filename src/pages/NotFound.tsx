    ...
    <div className="min-h-screen bg-[#030010] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto mb-6 h-20 w-20 rounded-3xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-white/10 flex items-center justify-center backdrop-blur-xl"
        >
          <Sparkles className="h-8 w-8 text-white/60" />
        </motion.div>

        {/* 404 Text */}
        <h1 className="text-7xl font-bold bg-gradient-to-r from-blue-400 via-white to-cyan-400 bg-clip-text text-transparent mb-4 tracking-tight">
          404
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Button
            ...
            className="h-12 px-6 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-400 hover:to-cyan-400 text-white font-semibold border-0 shadow-lg shadow-blue-500/20 transition-all"
          >
