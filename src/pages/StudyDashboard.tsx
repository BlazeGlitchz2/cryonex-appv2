  ...
  return (
    <div className="flex-1 h-full overflow-hidden relative bg-[#020005] text-white">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
         <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(124,58,237,0.15),_transparent_60%)]" />
        ...
        <div className="max-w-7xl mx-auto space-y-8 pb-20">
          ...
          <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              >
                <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-purple-500/20">
                  <Brain className="h-7 w-7 text-white" />
                </div>
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-white/70">
                    Study Hub
                  </h1>
                  <p className="text-sm text-white/50 font-medium flex items-center gap-2">
                    Master your knowledge <span className="inline-block w-1 h-1 rounded-full bg-white/30" /> Level {stats?.level || 1}
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex gap-3">
                <Button 
                    ...
                    className="bg-white text-black hover:bg-white/90 rounded-full px-6 h-11 font-semibold shadow-lg shadow-white/5 hover:shadow-white/10 transition-all hover:scale-105"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-4 space-y-6">
               ...
               <div className="grid grid-cols-2 gap-3">
                  <button className="p-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all flex flex-col items-center justify-center gap-2 text-sm font-medium text-white/80 hover:text-white group">
                    <div className="h-10 w-10 rounded-full bg-pink-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
