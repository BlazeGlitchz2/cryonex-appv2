        ...
        if (graphData && graphData.nodes.length > 0) {
            const { nodes: layoutedNodes, edges: layoutedEdges } = getLayoutedElements(
                graphData.nodes.map(n => ({
                    ...
                    style: { background: '#1a1a1a', color: '#fff', border: '1px solid #333', borderRadius: '8px', padding: '10px' }
                })),
                graphData.edges.map(e => ({ ...e, animated: true, style: { stroke: '#8b5cf6' } }))
            );
        ...
        <div className="h-screen w-full bg-[#030005] flex flex-col">
            <div className="p-4 border-b border-white/10 flex items-center justify-between bg-[#0A0A0B]">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Global view of all your concepts</p>
                    </div>
                </div>
            ...
            <div className="flex-1">
                ...
                >
                    ...
                    <MiniMap className="bg-[#1a1a1a] border-white/10" nodeColor="#8b5cf6" />
