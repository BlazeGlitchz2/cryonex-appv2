...
export function useChatEffects(convex: any, user: any, handleSend: (text: string) => void) {
    ...
    }, [location.state, initialMessageProcessed, navigate, location.pathname, handleSend]);
