...
export const COUNTRIES: Record<string, CountryConfig> = {
  sa: {
    ...
    currency: "SAR",
    schools: [
      { id: "ahis_dammam", name: "Alhussan International School - Dammam" },
      { id: "ahis_jubail", name: "Alhussan International School - Jubail" },
      { id: "ahis_khobar", name: "Alhussan International School - Khobar (Rakah)" },
      { id: "ahis_riyadh", name: "Alhussan International School - Riyadh" },
      { id: "ahis_yanbu", name: "Alhussan International School - Yanbu" },
      ...
      { id: "hussan_national_boys_dammam", name: "Alhussan National School (Boys) - Dammam" },
      { id: "hussan_national_girls_dammam", name: "Alhussan National School (Girls) - Dammam" },
      { id: "hussan_national_boys_jubail", name: "Alhussan National School (Boys) - Jubail" },
      { id: "hussan_national_girls_jubail", name: "Alhussan National School (Girls) - Jubail" },
      ...
      { id: "hussan_arar", name: "Alhussan School - Arar" },
      { id: "hussan_turaif", name: "Alhussan School - Turaif" },
      { id: "hussan_medina", name: "Alhussan School - Medina" },
      { id: "hussan_rakah", name: "Alhussan School - Rakah" },
