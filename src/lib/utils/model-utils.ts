...
export const IMAGE_MODELS: Model[] = [
  {
    ...
    contextWindow: 0,
    description: "Automatically uses Flux 2 Klein 4B via Pollinations (Free)",
    isImage: true,
    logo: "/logo.png",
    tags: ["Smart", "Auto", "Flux 2", "Free"],
    showcase: true,
  },
  {
    ...
    provider: "Pollinations",
    contextWindow: 0,
    description: "Advanced Flux 2 Klein 4B model - best for detailed images (Free)",
    isImage: true,
    tags: ["Free", "Flux 2", "High Quality", "Recommended"],
    showcase: true,
  },
  {
