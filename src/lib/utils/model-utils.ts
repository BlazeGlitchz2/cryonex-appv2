...
export const AVAILABLE_MODELS: Model[] = [
  ...
  },
  {
    ...
    provider: "Hugging Face",
    contextWindow: 8192,
    description: "Google Gemma 2 9B Instruct (Open Source)",
    tags: ["Hugging Face", "Gemma", "Open Source"],
    showcase: true,
  },
  {
    ...
    provider: "Hugging Face",
    contextWindow: 32000,
    description: "Alibaba Qwen 2.5 72B (Open Source)",
    tags: ["Hugging Face", "Qwen", "Open Source"],
    showcase: true,
  },
  {
    ...
    provider: "Hugging Face",
    contextWindow: 128000,
    description: "Microsoft Phi 3.5 Mini (Open Source, Long Context)",
    tags: ["Hugging Face", "Phi", "Open Source"],
  },
  {
  ...
  {
    id: "huggingface/01-ai/Yi-1.5-34B-Chat",
    name: "Yi 1.5 34B (HF)",
    provider: "Hugging Face",
    contextWindow: 16384,
    description: "01.AI Yi 1.5 34B Chat (Open Source)",
    tags: ["Hugging Face", "Yi", "Open Source"],
  },
  // Bytez Models
  {
    id: "bytez/gpt-4o",
  ...
  {
    id: "bytez/google/gemma-2-27b-it",
    name: "Gemma 2 27B (Bytez)",
    provider: "Bytez",
    contextWindow: 8192,
    description: "Google Gemma 2 27B Instruct (Open Source)",
    tags: ["Bytez", "Gemma", "Open Source"],
    showcase: true,
  },
  {
  ...
  {
    id: "bytez/openchat/openchat-3.5-0106",
    name: "OpenChat 3.5 (Bytez)",
    provider: "Bytez",
    contextWindow: 8192,
    description: "OpenChat 3.5 - High quality open chat model",
    tags: ["Bytez", "Chat", "Open Source"],
  },
  {
    id: "bytez/NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO",
    name: "Hermes 2 Mixtral (Bytez)",
    provider: "Bytez",
    contextWindow: 32000,
    description: "Nous Hermes 2 on Mixtral (Open Source)",
    tags: ["Bytez", "Hermes", "Open Source"],
  },
  // Meta
  {
