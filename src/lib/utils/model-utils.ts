...
export const AVAILABLE_MODELS: Model[] = [
  ...
  },
  {
    ...
    description: "Free MiniMax M2.5 routing for coding, agents and multilingual reasoning via OpenRouter",
    logo: "/logos/minimax.webp",
    tags: ["MiniMax", "OpenRouter", "Free", "Reasoning", "Coding", "Latest"],
    showcase: true,
  },
  {
    ...
    description: "Google's free Gemma 3 route with strong general reasoning and multimodal support",
    tags: ["Google", "Free", "Reasoning", "Multimodal"],
    showcase: true,
  },
  {
    ...
    provider: "Meta",
    contextWindow: 131072,
    description: "Free OpenRouter fallback for strong long-form reasoning and broad compatibility",
    logo: "/logos/meta.png",
    tags: ["Meta", "Free", "Fallback", "Reasoning"],
    showcase: true,
  },
  {
    ...
    description: "Pollinations free-tier vision model for image understanding and multimodal prompts",
    tags: ["Pollinations", "Vision", "Free", "Multimodal"],
    showcase: true,
  },
  {
    ...
    provider: "Other",
    contextWindow: 128000,
    description: "Free OpenRouter multimodal backup for image understanding when primary providers fail",
    tags: ["NVIDIA", "Free", "Vision", "Fallback"],
  },
  {
